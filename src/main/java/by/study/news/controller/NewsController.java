...
public class NewsController {
	...
	public String showEditArticlePage(@RequestParam("id") int id, Model model) {
	...
	public String saveArticle(@Valid @ModelAttribute("article") Article article, BindingResult theBindingResult) {

		// save the customer using our service
		newsService.save(article);

		if (theBindingResult.hasErrors()) {
			return "showAddArticlePage";
		} else {
